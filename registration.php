    ...
    <div class="container">
        ...
        if (isset($_POST["submit"])) {
            ...
            if (strlen($userName) < 1) {
                array_push($errors, "Username must be at least 1 character long");
            }
            ...
            if ($rowCount > 0) {
                ...
                // se não existir o email, então verifica o username
            ...
            if (count($errors) > 0) {
                ...
                if ($prepareStmt) {
                    ...
                    echo "<div class='alert alert-success'>Registered with success!.</div>";
                } else {
